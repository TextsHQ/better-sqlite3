      ...
      'conditions': [
        ...
        'OS == "ios"', {
          'link_settings': {
            'libraries': [
              # This statically links libcrypto, whereas -lcrypto would dynamically link it
              '<(SHARED_INTERMEDIATE_DIR)/sqlite3/OpenSSL-ios-<(target_arch)/libcrypto.a',
              '<(SHARED_INTERMEDIATE_DIR)/sqlite3/signal-tokenizer/>(rust_arch)-apple-ios/libsignal_tokenizer.a',
            ]
          }
        },
        { # Linux
